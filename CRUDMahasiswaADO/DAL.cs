...
namespace CRUDMahasiswaADO
{
...

    {
        ...
        {
            string connectionString = "Data Source=DIAN\\NAZARIN;Initial Catalog=DBAkademikADO;User ID=sa;Password=PasswordSA;";
        ...
        public void InsertMhs(string nim, string nama, string alamat, string jenisKelamin, DateTime tanggalLahir, string kodeProdi, byte[] foto)
        {
            ...
            {
                trans.Rollback();
                // optional: bisa tambah ini kalau mau lihat errornya
        ...
        public void testInject(string nim)
        {
            ...
            // Tanpa WHERE - semua data berubah jadi HACKED
            string query = "Update mahasiswa set nama = 'HACKED'";
